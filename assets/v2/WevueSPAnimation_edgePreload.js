...
if(document.addEventListener ){ 
   ...
   var assetsPath = "assets/v2/";

   aLoader = [
      { load: assetsPath + "edge_includes/jquery-2.0.3.min.js"},
      { load: assetsPath + "edge_includes/edge.4.0.1.min.js"},
      { load: assetsPath + "js/page_scroller.js", user: true },
      { load: assetsPath + "js/modernizr.custom.js", user: true },
      { load: assetsPath + "WevueSPAnimation_edge.js"},
      { load: assetsPath + "WevueSPAnimation_edgeActions.js"}];
...
var plSTF="both",ctrPlS="horizontal",minPlW="0",maxPlW=undefined,plWidth="1024px",plHeight="768px";
...
preContent={
    dom: [
    {
        ...
        fill: ["rgba(0,0,0,0)", assetsPath+'images/preloader2.gif','0px','0px']
    }]};//simpleContent
