...
if(document.addEventListener ){ 
   ...
   aLoader = [
      { load: aniPath +"edge_includes/jquery-2.0.3.min.js"},
      { load: aniPath +"edge_includes/edge.4.0.1.min.js"},
      { load: aniPath +"js/page_scroller.js", user: true },
      { load: aniPath +"js/modernizr.custom.js", user: true },
      { load: aniPath +"WevueSPAnimation_edge.js"},
      { load: aniPath +"WevueSPAnimation_edgeActions.js"}];
...
preContent={
    dom: [
    {
        ...
        fill: ["rgba(0,0,0,0)",aniPath +'images/preloader2.gif','0px','0px']
    }]};//simpleContent
